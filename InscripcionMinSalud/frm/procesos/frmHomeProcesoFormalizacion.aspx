<%@ Page Language="C#" MasterPageFile="~/frm/master/site2019.Master" AutoEventWireup="true" CodeBehind="frmHomeProcesoFormalizacion.aspx.cs" Inherits="InscripcionMinSalud.frm.procesos.frmHomeProcesoFormalizacion" %>
                ...
                <div class="col-lg-2 mtabs	">
                    <div class="menu-cont">
                        <ul>
                            ...
                            <li class="active"><a href="#">Formalización</a></li>
                            ...
                            <li>
                                <asp:HyperLink runat="server" ID="HyperLink5" NavigateUrl="../../frm/procesos/frmHomeProcesoEvaluacion.aspx">Evaluación e impacto</asp:HyperLink></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-10 amp-proces">
                    <h3>Formalización</h3>
                    <p>Texto Formalización</p>
                    <hr>
                    <div class="uitabs">
                        <ul class="tabs">
