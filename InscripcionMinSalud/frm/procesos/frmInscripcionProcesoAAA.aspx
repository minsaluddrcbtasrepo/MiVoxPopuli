<%@ Page Language="C#" MasterPageFile="~/frm/master/masterb.Master" AutoEventWireup="true" CodeBehind="frmInscripcionProcesoAAA.aspx.cs" Inherits="InscripcionMinSalud.frm.procesos.frmInscripcionProcesoAAA" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        $(function () {
            $("#txtCie10").autocomplete({
                select: function (e, ui) { $("#txtCie10").prop('title', ui.item.label); },
        ...
        $(function () {
            $("#txtCie10NuevoNombre").autocomplete({
                select: function (e, ui) { $("#txtCie10NuevoNombre").prop('title', ui.item.label); },
                messages: { noResults: '', results: function () { } },
                source: function (request, response) {
                    $.ajax({
                        url: "../ws/ws.asmx/obtenerEnfermedad",
        ...
        $(function () {
            $("#txtCupsConfirmatoriaActual").autocomplete({
                select: function (e, ui) { $("#txtCupsConfirmatoriaActual").prop('title', ui.item.label); },
                messages: { noResults: '', results: function () { } },
                source: function (request, response) {
                    $.ajax({
                        url: "../ws/ws.asmx/obtenerCups",
        ...
        $(function () {
            $("#txtCupsConformatoriaPropuesta").autocomplete({
                select: function (e, ui) { $("#txtCupsConformatoriaPropuesta").prop('title', ui.item.label); },
                messages: { noResults: '', results: function () { } },
                source: function (request, response) {
                    $.ajax({
                        url: "../ws/ws.asmx/obtenerCups",
    ...
    <script>
        ...
        function Ajustarcheck() {
            ...
            var chkInnovacion = $('#chkInnovacion').prop('checked');
            var chkEnfermedad = $('#chkEnfermedad').prop('checked');
            var chkFinanciero = $('#chkFinanciero').prop('checked');
            var chkIncorporada = $('#chkIncorporada').prop('checked');

            if ($('#chkFinanciada').prop('checked') == true) {
                $('#divFinanciacion').show();
            } else {
                $('#divFinanciacion').hide();
            }

            if ($('#chkGPC').prop('checked') == true) {
                $('#divGPC').show();
            } else {
                $('#divGPC').hide();
            }
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <fieldset runat="server" id="Fieldset1" class="form-group">
                        <legend><span>
                            <label runat="server" clientidmode="Static" id="lblenumeracionNatural">Criterios de nominación</label></span></legend>
                        ...
                        <div style="border-color: #f3a740; border-style: solid; border-width: 1px; padding: 10px 10px 10px 10px;" id="opcionCambio" runat="server">
                            <label for="chkPatologia" clientidmode="Static" runat="server" id="Label2">Seleccionar la opción que mejor describe su nominación. </label>
                            <br />
                            <div class="checklistn">
                                <asp:RadioButton runat="server" GroupName="grupoUno" ClientIDMode="Static" onchange="Ajustarcheck();" ID="chkInnovacion" />
                                <label>Tecnologías innovadoras:</label>
                                <label>Nuevas moléculas de un comprobado buen desempeño terapéutico (cura, remisión de la enfermedad o prevención) con alternativas terapéuticos limitadas</label>
                            </div>
                            <div class="checklistn">
                                <asp:RadioButton runat="server" GroupName="grupoUno" ClientIDMode="Static" onchange="Ajustarcheck();" ID="chkEnfermedad" />
                                <label>Tecnologías que atienden necesidades de enfermedades:</label>
                                <label>De baja prevalencia y alto costo o necesidades terapéuticas insatisfechas de enfermedades prevalentes</label>
                            </div>
                            <div class="checklistn">
                                <asp:RadioButton runat="server" GroupName="grupoUno" ClientIDMode="Static" onchange="Ajustarcheck();" ID="chkFinanciero" />

                                <label>Tecnologías que presenten o puedan presentar un impacto financiero sustancial</label>
                            </div>

                            <div class="checklistn">
                                <asp:RadioButton runat="server" GroupName="grupoUno" ClientIDMode="Static" onchange="Ajustarcheck();" ID="chkIncorporada" />

                                <label>Tecnologías incorporadas previamente en Acuerdos de Acceso Administrado a nivel global</label>
                            </div>
                        </div>
                        <br />
                        <legend><span>
                            <label runat="server" clientidmode="Static" id="Label15">Ficha de la tecnología en salud</label></span></legend>

                        <div>
                            <label clientidmode="Static" runat="server" id="lblNombre">Nombre Tecnología</label>
                            <asp:Image Width="20px" runat="server" ImageUrl="~/img/web/help.gif" ID="ayudaNombreTecnologia"
                                title="Escriba el nombre de la nominación de acuerdo a su selección." ToolTip="" /><label>Ayuda</label>
                            <asp:TextBox runat="server" Text="" type="text" name="name" ID="txtNombreTecnologia" MaxLength="100" CssClass="form-control" />


                            <label clientidmode="Static" runat="server" id="Label16">ATC</label>
                            <asp:Image Width="20px" runat="server" ImageUrl="~/img/web/help.gif" ID="Image17"
                                title="Escriba el codigo ATC de la tecnología." ToolTip="" /><label>Ayuda</label>
                            <asp:TextBox runat="server" Text="" type="text" name="name" ID="TextBox1" MaxLength="100" CssClass="form-control" />

                            <label clientidmode="Static" runat="server" id="Label17">Principio Activo</label>
                            <asp:Image Width="20px" runat="server" ImageUrl="~/img/web/help.gif" ID="Image18"
                                title="" ToolTip="" /><label>Ayuda</label>
                            <asp:TextBox runat="server" Text="" type="text" name="name" ID="TextBox2" MaxLength="100" CssClass="form-control" />

                            <label clientidmode="Static" runat="server" id="Label18">Forma Farmacéutica</label>
                            <asp:Image Width="20px" runat="server" ImageUrl="~/img/web/help.gif" ID="Image19"
                                title="" ToolTip="" /><label>Ayuda</label>
                            <asp:TextBox runat="server" Text="" type="text" name="name" ID="TextBox3" MaxLength="100" CssClass="form-control" />


                            <label clientidmode="Static" runat="server" id="Label19">Consentración</label>
                            <asp:Image Width="20px" runat="server" ImageUrl="~/img/web/help.gif" ID="Image20"
                                title="" ToolTip="" /><label>Ayuda</label>
                            <asp:TextBox runat="server" Text="" type="text" name="name" ID="TextBox4" MaxLength="100" CssClass="form-control" />

                            <label for="txtDescripJustifaca" clientidmode="Static" runat="server" id="Label20">Descripción de la Tecnología</label>
                            <asp:Image Width="20px" runat="server" ImageUrl="~/img/web/help.gif" ID="Image21"
                                title="Describa las razones de su nominación y justifique lo más completo posible" /><label>Ayuda</label>
                            <asp:TextBox runat="server" Text="" type="text" name="name" ID="TextBox5" TextMode="MultiLine" Height="200px" CssClass="form-control" ClientIDMode="Static" />

                            <label clientidmode="Static" runat="server" id="Label22">Nombre Comercial</label>
                            <asp:Image Width="20px" runat="server" ImageUrl="~/img/web/help.gif" ID="Image23"
                                title="" ToolTip="" /><label>Ayuda</label>
                            <asp:TextBox runat="server" Text="" type="text" name="name" ID="TextBox7" MaxLength="100" CssClass="form-control" />

                            <label clientidmode="Static" runat="server" id="Label23">Presentación</label>
                            <asp:Image Width="20px" runat="server" ImageUrl="~/img/web/help.gif" ID="Image24"
                                title="Vial, capsula, etc" ToolTip="" /><label>Ayuda</label>
                            <asp:TextBox runat="server" Text="" type="text" name="name" ID="TextBox8" MaxLength="100" CssClass="form-control" />


                            <div class="checklistn">
                                <label for="txtConflicto" clientidmode="Static" runat="server" id="Label37">Cuenta con registro sanitario?</label>
                                <br />
                                <asp:RadioButton GroupName="evidencia" onchange="Ajustarcheck();" ID="RadioButton5" runat="server"
                                    ClientIDMode="Static" Text="SI" />
                                <asp:RadioButton GroupName="evidencia" onchange="Ajustarcheck();" ID="RadioButton6" runat="server"
                                    ClientIDMode="Static" Text="NO" />
                            </div>


                            <label clientidmode="Static" runat="server" id="Label29">Indicación</label>
                            <asp:Image Width="20px" runat="server" ImageUrl="~/img/web/help.gif" ID="Image25"
                                title="" ToolTip="" /><label>Ayuda</label>
                            <asp:TextBox runat="server" Text="" type="text" name="name" ID="TextBox9" MaxLength="100" CssClass="form-control" />

                            <label clientidmode="Static" runat="server" id="Label30">Titular</label>
                            <asp:Image Width="20px" runat="server" ImageUrl="~/img/web/help.gif" ID="Image26"
                                title="" ToolTip="" /><label>Ayuda</label>
                            <asp:TextBox runat="server" Text="" type="text" name="name" ID="TextBox10" MaxLength="100" CssClass="form-control" />

                            <label clientidmode="Static" runat="server" id="Label31">Fabricante</label>
                            <asp:Image Width="20px" runat="server" ImageUrl="~/img/web/help.gif" ID="Image27"
                                title="" ToolTip="" /><label>Ayuda</label>
                            <asp:TextBox runat="server" Text="" type="text" name="name" ID="TextBox11" MaxLength="100" CssClass="form-control" />

                            <label clientidmode="Static" runat="server" id="Label32">Importador</label>
                            <asp:Image Width="20px" runat="server" ImageUrl="~/img/web/help.gif" ID="Image28"
                                title="" ToolTip="" /><label>Ayuda</label>
                            <asp:TextBox runat="server" Text="" type="text" name="name" ID="TextBox12" MaxLength="100" CssClass="form-control" />

                            <label clientidmode="Static" runat="server" id="Label33">Estado del Registro</label>
                            <asp:Image Width="20px" runat="server" ImageUrl="~/img/web/help.gif" ID="Image29"
                                title="" ToolTip="" /><label>Ayuda</label>
                            <asp:TextBox runat="server" Text="" type="text" name="name" ID="TextBox13" MaxLength="100" CssClass="form-control" />

                            <label clientidmode="Static" runat="server" id="Label34">Fecha de Ingreso al País</label>
                            <asp:Image Width="20px" runat="server" ImageUrl="~/img/web/help.gif" ID="Image30"
                                title="" ToolTip="" /><label>Ayuda</label>
                            <asp:TextBox runat="server" type="Date" TextMode="Date" name="name" ID="TextBox14" CssClass="form-control" />


                            <label for="txtDescripJustifaca" clientidmode="Static" runat="server" id="Label21">Necesidades Específicas para su Administración</label>
                            <asp:Image Width="20px" runat="server" ImageUrl="~/img/web/help.gif" ID="Image22"
                                title="centros de infusión, entrenamiento del personal, dispositivos médicos especiales requeridos, entre otros" /><label>Ayuda</label>
                            <asp:TextBox runat="server" Text="" type="text" name="name" ID="TextBox6" TextMode="MultiLine" Height="200px" CssClass="form-control" ClientIDMode="Static" />

                            <legend><span>
                            <label runat="server" clientidmode="Static" id="Label24">Información Adicional</label></span></legend>


                            <div class="checklistn">
                                <label for="txtConflicto" clientidmode="Static" runat="server" id="Label36">¿Se encuentra financiada con recursos públicos?</label>
                                <br />
                                <asp:RadioButton GroupName="evidencia" onchange="Ajustarcheck();" ID="chkFinanciada" runat="server"
                                    ClientIDMode="Static" Text="SI" />
                                <asp:RadioButton GroupName="evidencia" onchange="Ajustarcheck();" ID="RadioButton4" runat="server"
                                    ClientIDMode="Static" Text="NO" />
                            ...
                            <div id="divFinanciacion">
                                ...
                                <label clientidmode="Static" runat="server" id="Label3">¿Bajo qué mecanismo de financiación?</label>
                                <asp:Image Width="20px" runat="server" ImageUrl="~/img/web/help.gif" ID="Image1"
                                    title="" ToolTip="" /><label>Ayuda</label>
                                <asp:TextBox runat="server" Text="" type="text" name="name" ID="TextBox16" MaxLength="100" CssClass="form-control" />

                            </div>
                            <div class="checklistn">
                                <label for="txtConflicto" clientidmode="Static" runat="server" id="Label7">¿La enfermedad a la que atiende cuenta con guía de práctica clínica –GPC– en el país?</label>
                                <br />
                                <asp:RadioButton GroupName="evidencia" onchange="Ajustarcheck();" ID="chkGPC" runat="server"
                                    ClientIDMode="Static" Text="SI" />
                                <asp:RadioButton GroupName="evidencia" onchange="Ajustarcheck();" ID="RadioButton8" runat="server"
                                    ClientIDMode="Static" Text="NO" />

                            </div>

                            <div id="divGPC">
                                <label clientidmode="Static" runat="server" id="Label11">¿Cuál GPC y qué versión?</label>
                                <asp:Image Width="20px" runat="server" ImageUrl="~/img/web/help.gif" ID="Image2"
                                    title="" ToolTip="" /><label>Ayuda</label>
                                <asp:TextBox runat="server" Text="" type="text" name="name" ID="TextBox17" MaxLength="100" CssClass="form-control" />

                            </div>
                            <div class="checklistn">
                                <label for="txtConflicto" clientidmode="Static" runat="server" id="Label12">¿La tecnología se encuentra dentro de la primera línea de atención?</label>
                                <br />
                                <asp:RadioButton GroupName="evidencia" onchange="Ajustarcheck();" ID="RadioButton9" runat="server"
                                    ClientIDMode="Static" Text="SI" />
                                <asp:RadioButton GroupName="evidencia" onchange="Ajustarcheck();" ID="RadioButton10" runat="server"
                                    ClientIDMode="Static" Text="NO" />

                            </div>


                            <label for="txtDescripJustifaca" clientidmode="Static" runat="server" id="Label35">¿Por qué la tecnología amerita una negociación centralizada?</label>
                            <asp:Image Width="20px" runat="server" ImageUrl="~/img/web/help.gif" ID="Image31"
                                title="centros de infusión, entrenamiento del personal, dispositivos médicos especiales requeridos, entre otros" /><label>Ayuda</label>
                            <asp:TextBox runat="server" Text="" type="text" name="name" ID="TextBox15" TextMode="MultiLine" Height="200px" CssClass="form-control" ClientIDMode="Static" />
                         ...
                         <%--   <legend>Información adicional</legend>
                            ...
                            <div class="checklistn">
                                ...
                                <br />
                                <asp:RadioButton GroupName="evidencia" onchange="Ajustarcheck();" ID="RadioButton1" runat="server"
                                    ClientIDMode="Static" Text="SI" />
                                <asp:RadioButton GroupName="evidencia" onchange="Ajustarcheck();" ID="RadioButton2" runat="server"
                                    ClientIDMode="Static" Text="NO" />
                            ...
                            <ul>
                                <ol>
                                    <strong>Interés económico con personas respecto de las cuales tenga parentesco por consanguinidad, afinidad o vínculo civil :</strong>
                                    (Si tiene intereses en esta categoría describa los vínculos e intereses, en caso contrario, escriba “ninguno”, conforme lo descrito en el numeral 4)
                                    <asp:TextBox runat="server" CssClass="form-control" ID="txtInteresEconomico" TextMode="MultiLine" Width="700px" Height="80px"></asp:TextBox>
                                </ol>

                                <ol>
                                    <strong>Interés no económico personal:</strong>
                                    (Si tiene intereses en esta categoría describa los vínculos e intereses, en caso contrario, escriba “ninguno”)
                ...
                <div class="form-group">
                    <asp:Button runat="server" ClientIDMode="Static"
                        OnClientClick="return confirm('Esta seguro de enviar el formulario una vez enviado no podra realizar ningun cambio a la nominación');"
