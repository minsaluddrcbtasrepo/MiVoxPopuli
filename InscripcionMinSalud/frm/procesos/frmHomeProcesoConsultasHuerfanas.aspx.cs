...
{
    public partial class frmHomeProcesoConsultasHuerfanas : System.Web.UI.Page
    {
        /// <summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    lblMensaje.Text = "No se han realizado los encuentros en ciudades, los cuales se encuentran programados para el último trimestre de 2019";
                }
                if (Request.QueryString["v"] != null && Request.QueryString["v"] == "4")
                {
                    lblMensajeParticipe.Text = "No se han realizado los encuentros en ciudades, los cuales se encuentran programados para el último trimestre de 2019";
                }
            }
        }
