<%@ Page Language="C#" MasterPageFile="~/frm/master/site2019.Master" AutoEventWireup="true" CodeBehind="frmSolicitarRevision.aspx.cs" Inherits="InscripcionMinSalud.frm.procesos.SolicitarRevision" %>
    ...
    <div class="row">
        <div class="container">
            <div class="col-md-6 col-md-offset-3">
                ...
                <p class="centerp"><b>FORMATO DE TECNOLOGÍAS NOMINADAS PARA REVISÓN DE CRITERIOS EXCLUYENTES </b></p>
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <fieldset runat="server" id="Fieldset1" class="form-group">
                        <legend><span>
                            <label runat="server" clientidmode="Static" id="lblenumeracionNatural">Información de la tecnología excluida</label></span></legend>
                        ...
                        <div style="border-color: #f3a740; border-style: solid; border-width: 1px; padding: 10px 10px 10px 10px;">
                            <label for="chkPatologia" clientidmode="Static" runat="server" id="Label2">Tipo de tecnología excluida </label>
                            <br />
                            <div class="checklistn">
                                <asp:RadioButton runat="server" GroupName="grupoUno" ClientIDMode="Static" onchange="Ajustarcheck();" ID="chkEsMedicamento" Enabled="false" />

                                <label>Es medicamento</label>
                            </div>
                            <div class="checklistn">
                                <asp:RadioButton runat="server" GroupName="grupoUno" ClientIDMode="Static" onchange="Ajustarcheck();" ID="chkEsProcedimiento" Enabled="false" />

                                <label>Es procedimiento</label>
                            </div>
                            <div class="checklistn">
                                <asp:RadioButton runat="server" GroupName="grupoUno" ClientIDMode="Static" onchange="Ajustarcheck();" ID="chkEsDispositivoMedico" Enabled="false" />

                                <label>Es dispositivo medico</label>
                            </div>
                            <div class="checklistn">
                                <asp:RadioButton runat="server" GroupName="grupoUno" ClientIDMode="Static" onchange="Ajustarcheck();" ID="chkServicioSalud" Enabled="false" />

                                <label>Es servicio de salud</label>
                            </div>

                            <div class="checklistn">
                                <asp:RadioButton runat="server" GroupName="grupoUno" ClientIDMode="Static" onchange="Ajustarcheck();" ID="chkEsOtro" Enabled="false" />

                                <label>Otro</label>

                            </div>
                        </div>
                        <label for="txtNombreTecnologia" clientidmode="Static" runat="server" id="Label7">Nombre de la tecnología excluida</label>
                        <asp:Image Width="20px" runat="server" ImageUrl="~/img/web/help.gif" ID="imgTooltip"
                            title="Nombre genérico de la tecnología excluida
                                    ...
                                    " /><label>Ayuda</label>
                        <asp:TextBox runat="server" Text="" ReadOnly="true" type="text" name="name" ID="txtNombreTecnologia" MaxLength="100" CssClass="form-control" ClientIDMode="Static" />
                        <br/>

                        <div id="divEnfermedad">
                            <label for="txtEnfermedad" clientidmode="Static" runat="server" id="Label9">Nombre la enfermedad o condición de salud que motivo la exclusión de la tecnologia.  </label>
                            <asp:TextBox runat="server" ReadOnly="true" Text="" type="text" name="name" ID="txtEnfermedad" TextMode="MultiLine" Height="50px" MaxLength="500" CssClass="form-control" ClientIDMode="Static" />

                            <label for="txtEnfermedad2" clientidmode="Static" runat="server" id="Label14">Observaciones que motivan la nominación por no aplicación de criterio(s) excluyente(s)</label>
                            <asp:Image Width="20px" runat="server" ImageUrl="~/img/web/help.gif" ID="Image2"
                                title="Describa la razon(es)por la(s) cuale(s) nomina la exclusión por no aplicación de criterio(s) excluyente(s) (maximo 1000 caracteres) " /><label>Ayuda</label>
                            <asp:TextBox runat="server" Text="" type="text" name="name" ID="txtObservacionesNotivanNominacion" TextMode="MultiLine" Height="50px" MaxLength="3500" CssClass="form-control" ClientIDMode="Static" />

                            <br />
                        </div>
                        <asp:Panel runat="server" ID="pnlValidacionObservacionesNominacion" Visible="false">
                            <label for="cmbGrupoNombreTecnologia" clientidmode="Static" runat="server" id="Label3">Validación de las observaciones  de la nominación </label>
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TRANSPLANTESConnectionString %>" SelectCommand="SELECT [COD_PARAMETRO_VALIDACION], [DESCRIPCION] FROM [PARAMETRO_VALIDACION] WHERE ([COD_GRUPO_PARAMETRO_VALIDACION] = @COD_GRUPO_PARAMETRO_VALIDACION) ORDER BY [DESCRIPCION]">
                                <SelectParameters>
                    ...
                    <fieldset>
                        <legend><span>Información de criterio(s) de exclusión sobre el cual solicita la revisión</span></legend>
                        <p>Seleccione el criterio o los criterios que justifiquen la nominación de la exclusión por no aplicación de criterio(s) excluyente(s)</p>

                        <div id="criterioB" class="checklistn" runat="server">
                            <asp:CheckBox onchange="Ajustarcheck();" ID="chkExclusionB" runat="server" ClientIDMode="Static" />
                            <label for="chkExclusionB" clientidmode="Static" runat="server" id="Label5">Criterio B) Que no exista evidencia científica sobre su seguridad y eficacia clínica. </label>
                            ...
                            <div id="criterioC" class="checklistn" runat="server">

                                <asp:CheckBox onchange="Ajustarcheck();" ID="chkExclusionC" runat="server" ClientIDMode="Static" />
                                <label for="chkExclusionC" clientidmode="Static" runat="server" id="Label16">Criterio C) Que no exista evidencia científica sobre su efectividad clínica. </label>
                        ...
                        <div id="criterioD" class="checklistn" runat="server">
                            <asp:CheckBox onchange="Ajustarcheck();" ID="chkExclusionD" runat="server" ClientIDMode="Static" />
                            <label for="chkExclusionD" clientidmode="Static" runat="server" id="Label18">Criterio D) Que su uso no haya sido autorizado por la autoridad competente. </label>
                        ...
                        <div id="criterioE" class="checklistn" runat="server">
                            <asp:CheckBox onchange="Ajustarcheck();" ID="chkExclusionE" runat="server" ClientIDMode="Static" />
                            <label for="chkExclusionE" clientidmode="Static" runat="server" id="Label20">Criterio E) Que se encuentren en fase de experimentación. </label>
                    ...
                    <br />
                    <fieldset>
                        <legend><span>Información adicional</span></legend>
                        ...
                        <br />
                        <label for="chkConflictoInteres" clientidmode="Static" runat="server" id="Label25"></label>
                        <legend><span>Conflicto de intereses</span></legend>
                    ...
                    <div id="pnlAcepto">
                        ...
                        <div class="form-group">
                            <asp:Button runat="server" ClientIDMode="Static"
                                OnClientClick="return confirm('Esta seguro de enviar esta nominación?. Una vez enviado no podra realizar ningun ajuste');"
