<%@ Page Language="C#"  MasterPageFile="~/frm/master/site2019.Master" AutoEventWireup="true" CodeBehind="frmDecisionSeguimientoCUPS.aspx.cs" Inherits="InscripcionMinSalud.frm.procesos.frmDecisionSeguimientoCUPS" %>
                ...
                <div class="col-lg-2 mtabs	">
                    <div class="menu-cont">
                        <ul>
                            ...
                            <li><a id="lnkNominacion">Nominación</a></li>
                            <li>
                ...
                <div class="col-lg-10 amp-proces">
                    ...
                    <div class="uitabs">
                        <ul class="tabs">
                            ...
                            <li class="tab-link active" data-tab="tab-2" onclick="Click2()">Resultados</li>
                        </ul>
                        ...
                        <div id="tab-2" class="tab-content current">
                            ...
                            <div id="tab2Existe">
                                <asp:Repeater runat="server" ID="rptArchivosResultados" DataSourceID="SqlDataSourceArchivosResultado">
                                    <HeaderTemplate>
                                 ...
                                 <asp:SqlDataSource ID="SqlDataSourceArchivosResultado" runat="server" ConnectionString="<%$ ConnectionStrings:TRANSPLANTESConnectionString %>" 
