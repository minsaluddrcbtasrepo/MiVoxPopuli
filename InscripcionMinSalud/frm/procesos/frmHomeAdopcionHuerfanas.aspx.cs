...
{
    public partial class frmHomeAdopcionHuerfanas : System.Web.UI.Page
    {
        /// <summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    c = obj.obtenerProceso(int.Parse(Request.QueryString["cod"]));
                }               
                ...
                // Configura las URL de los hipervínculos lnkAnalisis, lnkAdopcion, lnkHome con los parámetros de la cadena de consulta
