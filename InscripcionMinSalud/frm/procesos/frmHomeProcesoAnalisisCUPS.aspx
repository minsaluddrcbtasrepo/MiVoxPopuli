<%@ Page Language="C#"  MasterPageFile="~/frm/master/site2019.Master" AutoEventWireup="true" CodeBehind="frmHomeProcesoAnalisisCUPS.aspx.cs" Inherits="InscripcionMinSalud.frm.procesos.frmHomeProcesoAnalisisCUPS" %>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-10 amp-proces">
                    ...
                    <p>
                        Minsalud y los expertos del país de acuerdo a cada especialidad, analizan cada una de los procedimientos nominados para determinar una decisión frente a la actualización de la CUPS
                    </p>
                    <hr>
                    <div class="uitabs">
                        <ul class="tabs">
