<%@ Page Language="C#" MasterPageFile="~/frm/master/site2019.Master" AutoEventWireup="true" CodeBehind="frmHomeProcesoEvaluacion.aspx.cs" Inherits="InscripcionMinSalud.frm.procesos.frmHomeProcesoEvaluacion" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-2 mtabs	">
                    <div class="menu-cont">
                        <ul>
                            <li>
                                <asp:HyperLink runat="server" ID="HyperLink1" NavigateUrl="../../frm/procesos/frmHomeProcesoNominacionAAA.aspx"></asp:HyperLink></li>
                            <li>
                                <asp:HyperLink runat="server" ID="HyperLink2" NavigateUrl="../../frm/procesos/frmHomeProcesoNegociacion.aspx">Negociación</asp:HyperLink></li>
                            <li>
                                <asp:HyperLink runat="server" ID="HyperLink3" NavigateUrl="../../frm/procesos/frmHomeProcesoFormalizacion.aspx">Formalización</asp:HyperLink></li>
                            <li>
                                <asp:HyperLink runat="server" ID="HyperLink4" NavigateUrl="../../frm/procesos/frmHomeProcesoImplementacion.aspx">Implementación y seguimiento</asp:HyperLink></li>
                            <li class="active"><a href="#">Evaluación e impacto</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-10 amp-proces">
                    <h3>Evaluación e impacto</h3>
                    <p>Texto Evaluación e impacto</p>
                    <hr>
                    <div class="uitabs">
                        <ul class="tabs">
                        ...
                        <div id="tab-2" class="tab-content current">
                            ...
                            <h3>
                                <asp:Label ID="lblMensaje" runat="server"></asp:Label></h3>
                        </div>
