<%@ Page Language="C#"  MasterPageFile="~/frm/master/site2019.Master" AutoEventWireup="true" CodeBehind="frmHomeProcesoConsultasHuerfanas.aspx.cs" Inherits="InscripcionMinSalud.frm.procesos.frmHomeProcesoConsultasHuerfanas" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-2 mtabs	">
                    <div class="menu-cont">
                        <ul>
                            <li>
                                <asp:HyperLink runat="server" ID="lnkHome" NavigateUrl="../../frm/procesos/frmHomeProcesoNominacionHuerfanas.aspx">Nominación y priorización</asp:HyperLink></li>
                            <li>
                ...
                <div class="col-lg-10 amp-proces">
                    ...
                    <p>
                        Conozca los resultados de los encuentros con usuarios, pacientes y la ciudadanía en general sobre los resultados de las nominaciones realizadas. 
                    ...
                    <div class="uitabs">
                        ...
                        <div id="tab-0" class="tab-content">
                            <h3><asp:Label ID="lblMensajeParticipe" runat="server" Text="El proceso de participación de la fase de “CONSULTA A PACIENTES POTENCIALMENTE AFECTADOS Y CIUDADANÍA” ha finalizado para esta vigencia"></asp:Label></h3>
                        </div>
