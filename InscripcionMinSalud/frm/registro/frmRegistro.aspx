<%@ Page Title="" Language="C#" MasterPageFile="~/frm/master/masterb.Master" AutoEventWireup="true" CodeBehind="frmRegistro.aspx.cs" Inherits="InscripcionMinSalud.frm.registro.frmRegistro" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function validarDocumento(event) {
            var respuesta = false;
            var comboSub2 = $('#cmbTipoDocumentoNatural').val();
            if (comboSub2 == '3' || comboSub2 == '5') {
                respuesta = validarAlfanumerico(event);
            } else {
                respuesta = validarNumero(event);
            }

            return respuesta;
        }

        function validarDocumentoRepresentante(event) {
            var respuesta = false;
            var comboSub2 = $('#cmbTipoDocumentoRepresentante').val();
        ...
        function GetDropDownDataDosP(combo) {
            ...
            function ClicBotonFinalizar() {
                //Visibility
                document.getElementById("ctl00$ContentPlaceHolder1$btnRegistrar").disabled = false;
            }
        ...
        function AjustarPantalla() {
            ...
            if (tipo == "39" || tipo == "40" || tipo == "41" || tipo == "42" || tipo == "43" || tipo == "44" || tipo == "45" ||
                ...
                lbltituloArchivoJuridico1.innerText = "Adjunte el certificado de existencia y representación legal que corresponda al tipo de sociedad";
                lbltituloArchivoJuridico1.innerHTML;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row" style="margin-right: 0px  !important; margin-left: -0px  !important;">
        <div class="container">
            ...
            <div class="row">
                <p>
                    Autorizo a la Dirección de Regulación de Beneficios, Costos y Tarifas del Aseguramiento en Salud del Ministerio de Salud y Protección Social, para que en los términos establecidos en la Ley 1581 de 2012, el Decreto Reglamentario 1377 de 2013 y las demás normas concordantes, realice el tratamiento de los datos personales que consignaré en el presente formulario de registro a MI VOX PÓPULI.
                </p>
                ...
                <div class="col-md-8 col-md-offset-2">
                    <fieldset class="form-group">
                        ...
                        <label for="cmbPerfil">
                            Seleccione el tipo de persona <span>(*)</span>
                        </label>

                        <asp:Image Width="20px" runat="server" ImageUrl="~/img/web/help.gif" ID="imgTooltip"
                            class="tooltip" title="Las organizaciones de usuarios (asociaciones de usuarios, veedurías, entre otras) deberán seleccionar “Persona jurídica”, esto es únicamente para uso de la plataforma" />
                    ...
                    <div id="pnlcombosJuridicos" style="display: none;">
                        <fieldset class="form-group">
                            ...
                            <label for="cmbSubtipo">
                                Seleccione un item de la lista<span> (*)</span>
                            </label>
                    ...
                    <div id="pnlDatosJuridicos" style="display: none;">
                        <fieldset runat="server" id="fieldJuridico" class="form-group">
                            ...
                            <asp:DropDownList runat="server" ID="cmbtipodocumentoentidad" onchange="AjustarPantalla();"
                                ClientIDMode="Static" CssClass="form-control" DataTextField="Nombre" DataValueField="Id">
                            </asp:DropDownList>
                            ...
                            <div>
                                <asp:TextBox runat="server" Style="display: inline-block !important;" type="text" name="name"
                                    ID="txtDocumentoJuridico"
                                    MaxLength="100" Width="180" CssClass="form-control" />
                                <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender5" runat="server" FilterType="Custom"
                                    ValidChars="0123456789" TargetControlID="txtDocumentoJuridico" />



                                <div id="divdigitoVerificacion" style="display: inline-block !important;">
                                    -
                                     <asp:TextBox runat="server" Style="display: inline-block !important;" type="text" name="name"
                                         ID="txtDigitoVerificacion" Width="40" ClientIDMode="Static"
                                         MaxLength="1" CssClass="form-control" />
                                    <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender6" runat="server" FilterType="Custom"
                                        ValidChars="0123456789" TargetControlID="txtDigitoVerificacion" />
                            ...
                            <asp:UpdatePanel runat="server">
                                <ContentTemplate>
                                    ...
                                    <asp:DropDownList ID="cmbDepartamentoJuridico" runat="server" DataTextField="Nombre" DataValueField="Id"
                                        AutoPostBack="True" CssClass="form-control" DataSourceID="SqlDataSourceDepartamento">
                                    </asp:DropDownList>
                                    ...
                                    <asp:DropDownList ID="cmbMunicipioJuridico" runat="server" DataTextField="Nombre" DataValueField="Id"
                                        CssClass="form-control" DataSourceID="SqlDataSourceMunicipioJuridico">
                                    </asp:DropDownList>
                            ...
                            <div id="divNumeroRepresentados">
                                ...
                                <asp:DropDownList ID="cmbtipoRepresentados" runat="server"
                                    CssClass="form-control" DataSourceID="SqlDataSourceTipoRepresentados" DataTextField="TIPO_REPRESENTADO" DataValueField="COD_TIPO_REPRESENTADO">
                                </asp:DropDownList>
                            </div>

                            <label for="txtTelefonoJuridico" clientidmode="Static" id="lbl45">Teléfono fijo<span> (*)</span></label>
                            <asp:TextBox ID="txtTelefonoJuridico" onkeypress='return validarTelefono(event);' runat="server" type="text" name="phone" MaxLength="10" CssClass="form-control" />
                        ...
                        <fieldset runat="server" id="fldRepresentate" class="form-group">
                            ...
                            <asp:TextBox runat="server" type="text" name="name"
                                ...
                                onkeypress='return validarDocumentoRepresentante(event);'
                                MaxLength="100" CssClass="form-control" />
                            ...
                            <asp:TextBox ID="txtTelefonoRepresentante" onkeypress='return validarTelefono(event);' runat="server" type="text" name="phone" MaxLength="10" CssClass="form-control" />

                            <label for="txtTelefonoCelularRepresentante" id="lbl17">Teléfono celular</label>
                            <asp:TextBox ID="txtTelefonoCelularRepresentante" onkeypress='return validarTelefono(event);' runat="server" type="text" name="phone" MaxLength="10" CssClass="form-control" />
                    ...
                    <div id="pnlDatosNatural" style="display: none;">
                        <fieldset runat="server" id="Fieldset1" class="form-group">
                            ...
                            <asp:TextBox runat="server" type="text" name="name"
                                ...
                                onkeypress='return validarDocumento(event);'
                                MaxLength="100" CssClass="form-control" />
                            ...
                            <asp:TextBox ID="txtTelefonoNatural" onkeypress='return validarTelefono(event);' runat="server" type="text" name="phone" MaxLength="10" CssClass="form-control" />

                            <label for="txtTelefonoCelularNatural" id="lbl17">Teléfono celular</label>
                            <asp:TextBox ID="txtTelefonoCelularNatural" onkeypress='return validarTelefono(event);' runat="server" type="text" name="phone" MaxLength="10" CssClass="form-control" />
                        </fieldset>
                        <fieldset>
                    ...
                    <div id="pnlAcepto">
                        <div class="form-group" style="text-align: justify;">
                            <div class="row">
                                <div class="divLine">
                                    <asp:CheckBox ID="chkAutorizo" ClientIDMode="Static" runat="server" CssClass="checkbox2" Text=" Autorizo el uso de mi correo para recibir información del Ministerio de Salud y Protección Social." />
                                </div>
                                <div class="divLine">
                                    <asp:CheckBox ID="chkCertifico" onchange="Ajustarcheck();" ClientIDMode="Static" runat="server" CssClass="checkbox2" Text="Certifico que los datos consignados son verídicos y han sido registrados por mi propia decisión y voluntad" />
                                </div>
                                <div class="divLine">
                                    <asp:CheckBox onchange="Ajustarcheck();" ID="chkTerminosYCondiciones" ClientIDMode="Static" runat="server" Checked="false" CssClass="checkbox2" Text="Al registrarme <b>acepto</b> los <a id='terms_footer' href='#politicas_modal'>Términos y Condiciones</a> establecidos para la participación en la herramienta web, diseñada por el Ministerio de Salud y Protección Social." />
                                </div>
                            </div> 
                        ...
                        <div class="form-group">
                            <asp:Button runat="server" Style="display: none; height: 60%" ClientIDMode="Static"
    ...
    <div style="display: none">
        <div class="terminos2" id="politicas_modal">
            <br />
...
En la herramienta “Sistema de Registro de Participación Ciudadana”  podrán participar gratuitamente todas las personas naturales y jurídicas, que tengan domicilio o residencia en Colombia, y cuyo interés de participar en los procesos colectivos sobre los aspectos de la salud en Colombia sea propositivo, constructivo y dinámico, encaminado a la búsqueda del interés común por encima de cualquier interés particular que pueda existir. Para la inscripción y  participación se deberá tener en cuenta:
            ...
            <ul class="text_terms2" style="padding-left: 40px;">
                <li>En esta herramienta tienen lugar todas las personas mayores de edad que habitan en el territorio colombiano.
                </li>
                <li>La información reportada en cada uno de los campos solicitados en el formulario de registro deberá ser veraz, puntual y exacta.
                </li>
                <li>Los documentos que se adjunten en los campos que así lo requieran, se presumirán auténticos, atendiendo a lo establecido en el Art. 244 del Código General del Proceso (Ley 1564 de 2012.
                </li>
                <li>El usuario asignado a cada participante será su número de identificación, para  y su contraseña deberá tener unos caracteres de fácil recordación.
                </li>
                <li>En caso que la contraseña sea olvidada, deberá remitirse al módulo: ¿Olvidó su contraseña?, a través del cual podrá ingresar nuevamente a la herramienta. 
                </li>
                <li>Las personas que se inscriban en esta herramienta deberán mantener actualizada su información de contacto.
                </li>
                <li>En caso que los representantes legales, directores o designados de personas jurídicas sean sustituidos, su periodo haya finalizado u otra causa, deberá remitirse comunicación al correo electrónico: participaciónpos@minsalud.gov.co indicando cual será la persona que será asignada en sustitución de la anterior, acreditando de igual forma los requisitos establecidos al momento de diligenciamiento de la inscripción inicial en esta herramienta.
                </li>
                <li>
                El Ministerio de Salud y Protección Social, en cualquier momento podrá suspender, retirar o cancelar la participación en la herramienta “Sistema de Registro de Participación Ciudadana”, a cualquier usuario que se evidencie no cumple con los requisitos, o que a discreción del mismo considere que afecta el óptimo desarrollo de los eventos planeados. 
            </ul>
            <p class="text_terms2">
                <br />
                <b>Privacidad de la Información</b>
