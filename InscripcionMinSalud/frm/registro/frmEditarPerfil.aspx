<%@ Page Title="" Language="C#" MasterPageFile="~/frm/master/site2019.Master" AutoEventWireup="true" CodeBehind="frmEditarPerfil.aspx.cs" Inherits="InscripcionMinSalud.frm.registro.frmEditarPerfil" %>
...
|| event.charCode == 44 || event.charCode == 46
 ...
 //si esta chekeado acepto terminos muestra el boton
        ...
        function AjustarPantalla() {
            ...
            {
                 lbltituloArchivoJuridico1.innerText = "Acta de posesión";
                 lbltituloArchivoJuridico1.innerHTML;
            }else if (tipo == "32" ||tipo == "33" ||tipo == "34" ||tipo == "35" ||tipo == "36" ||tipo == "37" ||tipo == "38" )
            {
                 lbltituloArchivoJuridico1.innerText = "Certificado de Cámara de Comercio";
                 lbltituloArchivoJuridico1.innerHTML;
            ...
            {
                if(tipoD == "12"){
                    lbltituloArchivoJuridico1.innerText = "Acta de junta directiva vigente";
                    lbltituloArchivoJuridico1.innerHTML;
                    }else if(tipoD == "13"){
                     lbltituloArchivoJuridico1.innerText = "Resolución vigente";
                    lbltituloArchivoJuridico1.innerHTML;
                    }else{
                    lbltituloArchivoJuridico1.innerText = "Certificado de Cámara de Comercio";
                    lbltituloArchivoJuridico1.innerHTML;
                 ...
                 lbltituloArchivoJuridico1.innerText = "Documento de soporte ";
                 lbltituloArchivoJuridico1.innerHTML;
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <div class="container">
     <div class="row">
				<div class="tit-des">
					<div class="titular">
						<h2 class="sub"><strong>Mi</strong> perfíl</h2>
						<p class="desc-title">Edite sus opciones personales</p>
					</div>
				</div>
			</div>
    </div>
					...
					<div class="col-lg-2 mtabs	">
						<div class="menu-cont">
							...
							<ul>
								...
								<li><a class="activoip" href="../../frm/procesos/frmTematicasActivas.aspx">Calendario de eventos</a></li>
								
							</ul>
						</div>	
					</div>
					<div class="col-lg-10 amp-proces sp">
					
						<div class="uitabs">
							<ul class="tabs">
								<%--<li class="tab-link" data-tab="tab-1">1. Información de acceso</li>--%>
								<li class="tab-link active current" data-tab="tab-2">1. Información del usuario</li>
                      ...
                      <div class="form-group">
                                    <asp:Label ID="LblValidacionCamposContrasena" runat="server" ForeColor="#E4335C" Font-Size="14pt" />
                          </div>
                      <div class="form-group">
                                    <asp:Button runat="server" ClientIDMode="Static" OnClientClick="test();"
                                         ID="Button1" Text="Actualizar contraseña" CssClass="boton2"  OnClick="btnRegistrarPassword_Click"  />
    ...
    <asp:panel runat="server" ID="pnlNoValido" >
        <div class="row">
            <h2 class="tag"><asp:Label runat="server" ID="lblTitulo" Text="Opción deshabilitada"></asp:Label></h2>    
        </div>
        <div class="row">
            <div class="tagline">
                <h3><asp:Label runat="server" ID="lblContenido"  text="Esta opción se encuentra deshabilitada temporalmente"></asp:Label></h3>
            </div>
        </div>
    </asp:panel>

    <asp:Panel runat="server" ID="pnlValido" Visible="false">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-md-offset-1">
                    <asp:Panel runat="server" ID="pnlObservacionesValidacion">
                      <div class="form-group">
                            <label for="txtObservacionesValidacion" id="lbl50">Observaciones de validación</label>
                                        <asp:TextBox  ID="txtObservacionesValidacion"  ReadOnly="true"
                                            runat="server" CssClass="form-control" TextMode="MultiLine" Width="700" Height="80" >
                                        </asp:TextBox>
                                </div>
                        </asp:Panel>
                            <fieldset class="form-group">
                                <legend><span>1. Datos del usuario</span></legend>
                                 <asp:DropDownList enabled="false"  runat="server"  TabIndex="0" ID="cmbPerfil"  Width="100%" CssClass="form-control" 
                            ...
                            <div id="pnlcombosJuridicos" style="display:none;">
                                    <fieldset class="form-group">
                                <legend><span> Tipo de persona juridica</span></legend>
                                
                             <asp:DropDownList enabled="true"  ID="cmbsubTipo" runat="server"
                            ...
                            <div id="pnlcombostipo" style="display:none;">
                                    <fieldset class="form-group">
                                <legend><span>Actor del sistema</span></legend>
                                   
                                <asp:DropDownList enabled="true"  runat="server" onchange="AjusteComboSubTipo();" TabIndex="0"
                                     ID="cmbTipoUsuario"  Width="100%" CssClass="form-control" 
                                      ClientIDMode="Static" >
                                </asp:DropDownList>  

                                 <div id="divTipoDos" style="display:none;">
                                   
                                    <asp:DropDownList enabled="true"  runat="server"  onchange="AjusteComboSubTipoDos();" TabIndex="0" 
                            ...
                            <div id="pnlDatosJuridicos" style="display:none;">
                              ...
                              <asp:Image Width="20px" Style="" runat="server" ImageUrl="~/img/web/help.gif" ID="Image3"
                                ...
                                <asp:TextBox readonly="false" runat="server"  type="text" name="name" 
                                    ID="txtNombreEntidad" 
                              ...
                              <asp:Image Width="20px" Style="" runat="server" ImageUrl="~/img/web/help.gif" ID="Image1"
                                ...
                                <asp:DropDownList enabled="true"  runat="server" ID="cmbtipodocumentoentidad" onchange="AjustarPantalla();" 
                              ...
                              <asp:Image Width="20px" Style="" runat="server" ImageUrl="~/img/web/help.gif" ID="Image2"
                                    ...
                                    <div>
                                <asp:TextBox readonly="false" runat="server" Style="display: inline-block !important;" onkeypress='return validarNumero(event);'  type="text" name="name" 
                                    ...
                                    MaxLength="100" Width="180" CssClass="form-control" /><div id="divdigitoVerificacion" Style="display: inline-block !important;"> -
                                     <asp:TextBox readonly="true" runat="server" Style="display: inline-block !important;"  onkeypress='return validarNumero(event);'  type="text" name="name" 
                                ...
                                <asp:TextBox readonly="false" runat="server" ID="txtFechaActa" Width="180"
                                ...
                                <asp:TextBox readonly="false" runat="server" ID="txtEspecialidad" 
                                    ClientIDMode="Static" CssClass="form-control" ></asp:TextBox>
                                    </div>
                                    <div id="divTipoIps">
                                           <label for="cmbTipoIps" ClientIDMode="Static" runat="server" id="Label5">Tipo de IPS <span> (*)</span></label>
                                        <asp:DropDownList enabled="true"  ID="cmbTipoIps" runat="server"
                                 ClientIDMode="Static" AppendDataBoundItems="True"
                                 CssClass="form-control"
                              ...
                              <ContentTemplate>
                                        ...
                                        <asp:DropDownList enabled="true"  ID="cmbDepartamentoJuridico" runat="server"  DataTextField="Nombre" DataValueField="Id" 
                                        ...
                                        <asp:DropDownList enabled="true"  ID="cmbMunicipioJuridico" runat="server" DataTextField="Nombre" DataValueField="Id" 
                                ...
                                <asp:TextBox readonly="false" runat="server"  type="text" name="name" ID="txtdireccionJuridico" MaxLength="150" TextMode="MultiLine" 
                                    CssClass="form-control" />
                                ...
                                <asp:DropDownList enabled="true"  ID="cmbtipoZonaJuridico" runat="server" ClientIDMode="Static" AppendDataBoundItems="True"  CssClass="form-control"
                                ...
                                <asp:TextBox readonly="false" ID="txtNumeroRepresentante" onkeypress='return validarNumero(event);' runat="server" type="text" name="number" Width="30%" CssClass="form-control" MaxLength="7" />
                                        ...
                                        <asp:DropDownList enabled="true"  ID="cmbtipoRepresentados" runat="server" 
                                ...
                                <asp:TextBox readonly="false" ID="txtTelefonoJuridico" onkeypress='return validarTelefono(event);' runat="server" type="text" name="phone" MaxLength="10" CssClass="form-control" />
                                    ...
                                    class="tooltip" title="A este correo recibirá las notificaciones del sistema." />                           
                                     <asp:TextBox readonly="false" runat="server" type="email" name="email" ID="txtcorreoinstitucional"  CssClass="form-control" MaxLength="100"/>                                
                                    ...
                                    class="tooltip" title="Con este nombre de usuario podra ingresar al Sistema." />                           
                                     <asp:TextBox readonly="true" runat="server" name="usuario" ID="txtUsuarioJuridico"  CssClass="form-control" MaxLength="100"/>                                
                              

                                    </asp:panel>
                                     <label for="txtcorreoAlternoInstitucional" id="lbl19">Correo electrónico alterno</label>                                     
                                    <asp:TextBox readonly="false" runat="server"  type="email" name="email" ID="txtcorreoAlternoInstitucional"  CssClass="form-control" MaxLength="100"/>
                                        ...
                                        <asp:DropDownList enabled="true"  ID="cmbPreguntaSecretaJuridica" runat="server" CssClass="form-control"
                                        ...
                                        <asp:TextBox readonly="false" ID="txtRespuestaPreguntaJuridica" runat="server" CssClass="form-control" MaxLength="30" >
                                        </asp:TextBox><br />
                            ...
                            <div runat="server" id="pnlArchivoJuridico1">
                                 <label for="divDocumentoNatural2" ClientIDMode="Static" runat="server" id="Label10">Documento de soporte  </label>              
                           ...
                           <div class='progressbar' id='progressbar3' style='width:100px;display:none;min-height:10px;background-color:green;'>
                                ...
                                <asp:DropDownList enabled="true"  runat="server" ID="cmbTipoDocumentoRepresentante" ClientIDMode="Static" CssClass="form-control" DataSourceID="SqlDataSourceTipoDocumentoNatural" DataTextField="Nombre" DataValueField="Id"></asp:DropDownList>
                                ...
                                <asp:TextBox readonly="false" runat="server" onkeypress='return validarNumero(event);'  type="text" name="name" 
                                    ID="txtNumeroDocumentoRepresentante" ClientIDMode="Static"
                                    MaxLength="100" CssClass="form-control" />
                                ...
                                <asp:TextBox readonly="false" runat="server" onkeypress='return validarSoloLetras(event);'  type="text" name="name" ID="txtNombresRepresentante"
                                     MaxLength="100" CssClass="form-control" />
                         
                                <label for="txtApellidosRepresentante" runat="server" id="Label12">Apellidos <span>(*)</span></label>
                                <asp:TextBox readonly="false" runat="server"  onkeypress='return validarSoloLetras(event);'   type="text" name="name" 
                                ...
                                <asp:DropDownList enabled="true"  ID="cmbSexoRepresentante"  runat="server" CssClass="form-control">
                                ...
                                <asp:TextBox readonly="false" ID="txtTelefonoRepresentante" onkeypress='return validarTelefono(event);' runat="server" type="text" name="phone" MaxLength="10" CssClass="form-control" />

                                <label for="txtTelefonoCelularRepresentante" id="lbl17">Teléfono celular</label>
                                <asp:TextBox readonly="false" ID="txtTelefonoCelularRepresentante"  onkeypress='return validarTelefono(event);' runat="server"  type="text" name="phone" MaxLength="10" CssClass="form-control" />
                                    ...
                                    class="tooltip" title="A este correo recibirá las notificaciones del sistema." />                           
                                     <asp:TextBox readonly="false" runat="server" type="email" name="email" ID="txtCorreoRepresentante"  CssClass="form-control" MaxLength="100"/> 
                                </fieldset>
                            ...
                            <div id="pnlDatosNatural" style="display:none;" >
                                ...
                                <asp:DropDownList enabled="true"  runat="server" ID="cmbTipoDocumentoNatural" ClientIDMode="Static" CssClass="form-control" DataSourceID="SqlDataSourceTipoDocumentoNatural" DataTextField="Nombre" DataValueField="Id"></asp:DropDownList>
                                ...
                                <asp:TextBox readonly="false" runat="server" onkeypress='return validarSoloLetras(event);'  type="text" name="name" ID="txtNombresNatural"
                                     MaxLength="100" CssClass="form-control" />
                         
                                <label for="txtApellidosNatural" runat="server" id="lbl5">Apellidos <span>(*)</span></label>
                                <asp:TextBox readonly="false" runat="server"  onkeypress='return validarSoloLetras(event);'   type="text" name="name" ID="txtApellidosNatural" MaxLength="50" CssClass="form-control" />

                                
                                <label for="cmbSexo" runat="server" id="lbl6">Sexo<span> (*)</span></label>
                                <asp:DropDownList enabled="true"  ID="cmbSexo"  runat="server" CssClass="form-control">
                                    <asp:ListItem Value="-1">Seleccione</asp:ListItem>
                                    <asp:ListItem Value="0">Femenino</asp:ListItem>
                                    <asp:ListItem Value="1">Masculino</asp:ListItem>
                                </asp:DropDownList>
                            ...
                            <asp:DropDownList enabled="true"   CssClass="form-control" ID="cmbPoblacionEspecial" runat="server" DataSourceID="SqlDataSourcePoblacionEspecial" DataTextField="NOMBRE_POBLACION_ESPECIAL" DataValueField="COD_POBLACION_ESPECIAL">
                            </asp:DropDownList>
                            ...
                            <div id="pnlPerfilesNaturales">
                                 ...
                                 <label for="dataPerfiles" runat="server" id="Label1">Marque una o varias opciones según corresponda</label>
                                        ...
                                        <asp:DataList ID="dataPerfiles" RepeatColumns="3" runat="server" DataKeyField="Id" DataSourceID="SqlDataSourcetipoUsuarioNuevoNatural">
                                            <ItemTemplate>
                                                ...
                                                <asp:CheckBox runat="server" CssClass="checkper"  ID="IdLabel" 
                                                  Text='<%# Eval("Nombre") %>' ValidationGroup='<%# Eval("Id") %>' />
                                                </div>
                                            </ItemTemplate>
                                        </asp:DataList>
                             ...
                             <asp:DropDownList enabled="true"   CssClass="form-control" ID="cmbNivelFormacion" runat="server" DataSourceID="SqlDataSourceNivelFormacion" DataTextField="NIVEL_FORMACION" DataValueField="COD_NIVEL_FORMACION">
                             </asp:DropDownList>
                            ...
                            <asp:UpdatePanel runat="server">
                              <ContentTemplate>
                                        ...
                                        <asp:DropDownList enabled="true"  ID="cmbDepartamentoNatural" runat="server"  DataTextField="Nombre" DataValueField="Id" 
                                            AutoPostBack="True"  CssClass="form-control" DataSourceID="SqlDataSourceDepartamento"></asp:DropDownList>
                                        ...
                                        <asp:DropDownList enabled="true"  ID="cmbMunicipioNatural" runat="server" DataTextField="Nombre" DataValueField="Id"   CssClass="form-control" DataSourceID="SqlDataSourceMunicipioNatural"></asp:DropDownList>                                        
                            ...
                            <asp:TextBox readonly="false" runat="server"  type="text" name="name" ID="txtdireccionNatural" MaxLength="150" TextMode="MultiLine" CssClass="form-control" />
                            <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" FilterType="Custom" ValidChars=",.0123465789#abcdefghijklmnñopqrstuvwxyzABCDEFGHIJKLMNÑOPQRSTUVWXYZáéíóúÁÉÍÓÚ#- " 
                             ...
                             <asp:DropDownList enabled="true"   CssClass="form-control" ID="cmbTipoZona" runat="server" DataSourceID="SqlDataSourceTipoZona" DataTextField="TIPO_ZONA" DataValueField="COD_TIPO_ZONA">
                             </asp:DropDownList>
                             <asp:SqlDataSource ID="SqlDataSourceTipoZona" runat="server" ConnectionString="<%$ ConnectionStrings:TRANSPLANTESConnectionString %>" SelectCommand="SELECT [COD_TIPO_ZONA], [TIPO_ZONA] FROM [TIPO_ZONA]"></asp:SqlDataSource>
                                ...
                                <asp:TextBox readonly="false" ID="txtTelefonoNatural" onkeypress='return validarTelefono(event);' runat="server" type="text" name="phone" MaxLength="10" CssClass="form-control" />

                                <label for="txtTelefonoCelularNatural" id="lbl17">Teléfono celular</label>
                                <asp:TextBox readonly="false" ID="txtTelefonoCelularNatural"  onkeypress='return validarTelefono(event);' runat="server"  type="text" name="phone" MaxLength="10" CssClass="form-control" />
                             </fieldset>
                                <fieldset>
                                    ...
                                    class="tooltip" title="A este correo recibirá las notificaciones del sistema." />                           
                                     <asp:TextBox readonly="false" runat="server" type="email" name="email" ID="txtCorreoNatural"  CssClass="form-control" MaxLength="100"/>                                
                              

                                     <label for="txtCorreoNaturalAlternativo" id="lbl19">Correo electrónico alterno</label>                                     
                                    <asp:TextBox readonly="false" runat="server"  type="email" name="email" ID="txtCorreoNaturalAlternativo"  CssClass="form-control" MaxLength="100"/>
                                    ...
                                    class="tooltip" title="Con este nombre de usuario podra ingresar al Sistema." />                           
                                     <asp:TextBox readonly="true"  runat="server" name="usuario" ID="txtUsuario"  CssClass="form-control" MaxLength="100"/> 
                                             </asp:panel>
                                        ...
                                        <asp:DropDownList enabled="true"  ID="cmbPreguntaSecreta" runat="server" CssClass="form-control"
                                              AppendDataBoundItems="true"
                                             DataSourceID="SqlDataSourcePreguntaSecreta" DataTextField="TextoPregunta" DataValueField="Id">
                                            <asp:ListItem Text="Seleccione" Value="-1"></asp:ListItem>
                                        ...
                                        <asp:TextBox readonly="false" ID="txtRespuestaPregunta" runat="server" CssClass="form-control" MaxLength="30" >
                                        </asp:TextBox><br />
...
<div class="form-group" style="text-align: justify;"> 
                                        <asp:CheckBox Enabled="true" ID="chkAutorizo" ClientIDMode="Static" runat="server" CssClass="checkbox" Text=" Autorizo el uso del correo para recibir información del Ministerio de Salud y Protección Social." />

                                        <asp:CheckBox Enabled="true"  ID="chkCertifico" onchange="Ajustarcheck();"  ClientIDMode="Static" runat="server" CssClass="checkbox"  Text="Certifico que los datos consignados son verídicos y han sido registrados por mi propia decisión y voluntad" />

                                        <asp:CheckBox Enabled="true"  onchange="Ajustarcheck();"  ID="chkTerminosYCondiciones" ClientIDMode="Static" runat="server" Checked="false" CssClass="checkbox" Text="<b>Acepto</b> los <a id='terms_footer' href='#politicas_modal'>Términos y Condiciones</a> establecidos para la participación en la herramienta web, diseñada por el Ministerio de Salud y Protección Social." />
                                        &nbsp;&nbsp;&nbsp;    
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:Button runat="server" ClientIDMode="Static" OnClientClick="return test(this);"
                                         ID="btnRegistrar"    Text="Guardar cambios" CssClass="call"  OnClick="btnRegistrar_Click"  />
