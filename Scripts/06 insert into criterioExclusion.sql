...
insert into EXCLUSIONES.CriterioExcIusion (idCriterio,IdTecnoIogiaExcluida) values (3,51); 
...
--Criterio 4
insert into EXCLUSIONES.CriterioExcIusion (idCriterio,IdTecnoIogiaExcluida) values (4,5); 
insert into EXCLUSIONES.CriterioExcIusion (idCriterio,IdTecnoIogiaExcluida) values (4,107);

-- Criterio 5
insert into EXCLUSIONES.CriterioExcIusion (idCriterio,IdTecnoIogiaExcluida) values (5,64); 
